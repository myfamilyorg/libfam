...
#define polyvec_matrix_expand_row0 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row0)
void polyvec_matrix_expand_row0(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row1 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row1)
void polyvec_matrix_expand_row1(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row2 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row2)
void polyvec_matrix_expand_row2(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row3 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row3)
void polyvec_matrix_expand_row3(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row4 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row4)
void polyvec_matrix_expand_row4(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row5 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row5)
void polyvec_matrix_expand_row5(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row6 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row6)
void polyvec_matrix_expand_row6(polyvecl *rowa, polyvecl *rowb,
				const u8 rho[SEEDBYTES]);
#define polyvec_matrix_expand_row7 \
	DILITHIUM_NAMESPACE(polyvec_matrix_expand_row7)
