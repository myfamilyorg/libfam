...
#define KeccakP1600times4_InitializeAll \
	FIPS202X4_NAMESPACE(KeccakP1600times4_InitializeAll)
...
#define KeccakP1600times4_AddByte(states, instanceIndex, byte, offset)        \
	((unsigned char *)(states))[(instanceIndex) * 8 +                     \
	    ...
	    (byte)
#define KeccakP1600times4_AddBytes \
	FIPS202X4_NAMESPACE(KeccakP1600times4_AddBytes)
...
#define KeccakP1600times4_AddLanesAll \
	FIPS202X4_NAMESPACE(KeccakP1600times4_AddLanesAll)
...
#define KeccakP1600times4_OverwriteBytes \
	FIPS202X4_NAMESPACE(KeccakP1600times4_OverwriteBytes)
...
#define KeccakP1600times4_ExtractBytes \
	FIPS202X4_NAMESPACE(KeccakP1600times4_ExtractBytes)
...
#define KeccakP1600times4_ExtractAndAddLanesAll \
	FIPS202X4_NAMESPACE(KeccakP1600times4_ExtractAndAddLanesAll)
...
#define KeccakF1600times4_FastLoop_Absorb \
	FIPS202X4_NAMESPACE(KeccakF1600times4_FastLoop_Absorb)
...
#define KeccakP1600times4_12rounds_FastLoop_Absorb \
	FIPS202X4_NAMESPACE(KeccakP1600times4_12rounds_FastLoop_Absorb)
